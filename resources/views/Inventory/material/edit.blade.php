...
@section('content')
    <form action="{{ route('inventory-material.update', [$inventory->id]) }}" method="post" enctype="multipart/form-data" id="addInventoryForm">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="type" id="type" class="form-control" placeholder="Jenis Quarry" value="{{ $inventory->type }}" required>
                                </div>
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="owner_quarry">Pemilik Quarry</label>
                                <input type="text" class="form-control" id="owner_quarry" name="owner_quarry" placeholder="Pemilik Quarry" value="{{ $inventory->owner_quarry }}" required>
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="status_quarry">Status Quarry</label>
                                <input type="text" class="form-control" id="status_quarry" name="status_quarry" placeholder="Status Quarry" value="{{ $inventory->status_quarry }}" required>
                            </div>
                            <div class="form-group col-md-6">
