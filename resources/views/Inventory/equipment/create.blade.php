...
@section('content')
    <form action="{{ route('inventory-equipment.store') }}" method="post" enctype="multipart/form-data" id="addInventoryForm">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="type" id="type" class="form-control" placeholder="Tipe" value="{{ old('type') }}" required>
                                </div>
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="production_year">Tahun Pembuatan</label>
                                <input type="number" name="production_year" id="production_year" name="production_year" class="form-control" placeholder="Tahun Pembuatan" value="{{ old('production_year') }}" required>
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="owner_name">Nama Kepemilikan</label>
                                <input type="text" class="form-control" id="owner_name" name="owner_name" placeholder="Nama Kepemilkan" value="{{ old('owner_name') }}" required>
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="owner_year">Tahun Kepemilikan</label>
                                <input type="number" class="form-control" id="owner_year" name="owner_year" placeholder="Tahun Kepemilkan" value="{{ old('owner_year') }}" required>
                            </div>
                            <div class="form-group col-md-6">
