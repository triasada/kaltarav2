...
<div class="card">
    <div class="card-body">
        <form action="{{ route('expert-data.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="expire_date" id="expireDate" placeholder="Tanggal Expire" class="form-control" required>
                    </div>
                </div>
            </div>
