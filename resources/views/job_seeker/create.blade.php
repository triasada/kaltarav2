                ...
                <form action="{{ route('job-seeker.store') }}" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label>NIK</label>
                                <input type="number" name="id_number" id="idNumber" class="form-control" placeholder="NIK" required>
                            </div>
                            <div class="col-md-6">
                                <label>Tanggal Lahir</label>
                                <input type="text" name="birth_date" id="birthDate" class="form-control" placeholder="Tanggal Lahir" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="phone_number" id="phone_number" class="form-control" placeholder="Nomor HP (WA)" required>
                            </div>
                            <div class="col-md-6">
                                <label>Email</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="job_seeker_school_level_id" id="job_seeker_school_level_id" class="form-control" required>
                                    <option value="">Pilih Satu</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="class_certification_type_id" id="class_certification_type_id" class="form-control">
                                    <option value="">Pilih Satu</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                <label>Kode Sub Klasifikasi</label>
                                <input type="text" name="sub_classification_code" id="sub_classification_code" class="form-control" placeholder="Kode Sub Klasifikasi" required>
                            </div>
                            <div class="col-md-6">
                                <label>Nama Sub Klasifikasi</label>
                                <input type="text" name="sub_classification_name" id="sub_classification_name" class="form-control" placeholder="Nama Sub Klasifikasi" required>
                            </div>
                            <div class="col-md-6">
