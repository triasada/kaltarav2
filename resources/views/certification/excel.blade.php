    ...
    <table class="table table-stripped">
        <thead>
            <tr>
                ...
                <th>Email</th>
                <th>Pendidikan</th>
                <th>SKA Klasifikasi</th>
                <th>Nomor Sub Klasifikasi</th>
        ...
        <tbody>
            @foreach ($participants as $participant)
                <tr>
                    ...
                    <td>{{ $participant->skaClassification->name }}</td>
                    <td>{{ $participant->sub_classification_code }}</td>
                    <td>{{ $participant->sub_classification_name }}</td>
                    <td>{{ $participant->qualification->name }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
